...
IMPULSE_DENOISING=`echo "$DEFAULT_IMPULSE_DENOISING + $DENOISING_STEP * $STEP_COUNT" | bc -l`; IMPULSE_DENOISING=`round $IMPULSE_DENOISING`
...
LEVEL0_CONTRAST=`echo "$DEFAULT_CONTRAST - 1.5 * $CONTRAST_STEP * ($STEP_COUNT - 1)" | bc -l`
LEVEL1_CONTRAST=`echo "$DEFAULT_CONTRAST - 0.5 * $CONTRAST_STEP * ($STEP_COUNT - 1)" | bc -l`
...
CCCurve=1;0.05;0.5;0.35;0.35;0.35;0.05;0.35;0.35;
