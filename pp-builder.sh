...
IMPULSE_DENOISING=`echo "r = $DEFAULT_IMPULSE_DENOISING + $DENOISING_STEP * $STEP_COUNT; scale=0; r/1" | bc -l`
DENOISING_LUMA=`echo "$DEFAULT_DENOISING_LUMA + $DENOISING_STEP * $STEP_COUNT" | bc -l`
DENOISING_CHROMA=`echo "$DEFAULT_DENOISING_CHROMA + $DENOISING_STEP * $STEP_COUNT" | bc -l`

LEVEL0_CONTRAST=`echo "$DEFAULT_CONTRAST + 5 * $CONTRAST_STEP * ($STEP_COUNT - 1)" | bc -l`
LEVEL1_CONTRAST=`echo "$DEFAULT_CONTRAST + 4 * $CONTRAST_STEP * ($STEP_COUNT - 1)" | bc -l`
LEVEL2_CONTRAST=`echo "$DEFAULT_CONTRAST + 3 * $CONTRAST_STEP * ($STEP_COUNT - 1)" | bc -l`
LEVEL3_CONTRAST=`echo "$DEFAULT_CONTRAST + 2 * $CONTRAST_STEP * ($STEP_COUNT - 1)" | bc -l`
LEVEL4_CONTRAST=`echo "$DEFAULT_CONTRAST + $CONTRAST_STEP * ($STEP_COUNT - 1)" | bc -l`
